...
> **Historical (closed).** Everything in this roadmap is shipped. 0.12.x finished the brownfield-retrieval phase that started here as 0.11. Subsequent shipped: [`0.13-bug-flow-and-chef.md`](./0.13-bug-flow-and-chef.md) (cut 2026-04-25). Subsequent shipped + partially superseded: [`0.14-mockup-first-refinement.md`](./0.14-mockup-first-refinement.md) (α.1–α.6 cut 2026-04-26; α.7+ superseded). **Active roadmap: [`0.15-plate-brew.md`](./0.15-plate-brew.md)** (designing 2026-04-26). This doc is kept for the audit trail of how 0.7→0.12 was sequenced; don't re-edit it for new work.
